 <%@page import="com.xue.model.BookPageMes"%>
<%@page import="com.xue.model.Book"%>
...
<script type="text/javascript">
	...
	function findBookByPage(page) {
		$.ajax({
			url : "BookServlet",
			type : "post",
			data : {flag : "ajaxseletebynameandpage", name : $("#name").val(), bookId : $("#id").val(), currentPage : page},//传到后端的数据
			dataType : "json", 

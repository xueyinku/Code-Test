...
<body>
	<h1>添加会员信息画面</h1>
	<form action="CusDaAddServlet" method="post">
		<table>
			<tr>
				<td class="txtregist">会员编号</td>
				<td>
					<input class="textlogin1" type="text"  name="vip_no"/>
				</td>
			...
			<tr>
				...
				<td>
					<input class="textlogin1" type="text" name="user_name"/>
				</td>
			...
			<tr>
				...
				<td>
					<input class="textlogin1" type="text" name="vip_score"/>
				</td>
			...
			<tr>
				...
				<td>
					<input class="textlogin1" type="text" name="vip_tel"/>
				</td>
			...
			<tr>
				...
				<td class="textlogin1">
					<input type="radio" name="sex" value="男"/>男<input type="radio" value="女" name="sex"/>女
				</td>
				<td></td>
			</tr>
			<tr>
